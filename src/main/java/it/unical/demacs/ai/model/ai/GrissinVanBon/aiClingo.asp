...
adjacent(R1,C1, R2,C1) :- cell(R1,C1), cell(R2,C1), not singleWall(R1,C1,R2,C1), |R1-R2|=1.
adjacent(R1,C1, R1,C2) :- cell(R1,C1), cell(R1,C2), not singleWall(R1,C1,R1,C2), |C1-C2|=1.
...
:~ newPos(R,C), player(ID,_,_,_,"N"), me(ID), |4-C|=4. [1@1]
:~ newPos(R,C), player(ID,_,_,_,"S"), me(ID), |4-C|=4. [1@1]
:~ newPos(R,C), player(ID,_,_,_,"W"), me(ID), |4-R|=4. [1@1]
:~ newPos(R,C), player(ID,_,_,_,"E"), me(ID), |4-R|=4. [1@1]
